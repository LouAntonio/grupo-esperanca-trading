...
export default function ContactPage() {
	...
	const faqs = [
		{
			id: 'faq1',
			question: 'Os vossos sumos têm conservantes?',
			answer: 'Não. Todos os sumos Toto Drink são 100% naturais, produzidos sem qualquer tipo de conservante ou aditivo químico. Apenas fruta fresca angolana cuidadosamente seleccionada.',
		},
		{
			id: 'faq2',
			question: 'Como posso fazer uma encomenda?',
			answer: 'Pode fazer a sua encomenda entrando em contacto connosco através do telefone ou email disponíveis nesta página. Entregamos directamente à sua porta.',
		},
		{
			id: 'faq3',
			question: 'Fazem entregas para eventos e empresas?',
			answer: 'Sim! Oferecemos fornecimento de sumos naturais, quitutes e Frango Premium para empresas, festas, conferências e eventos privados. Temos opções de quantidade e personalização conforme a dimensão do seu evento.',
		},
	];
			...
			>
				<div className="page-hero-content">
					...
					<p className="page-hero-subtitle">
						Estamos aqui para ajudar. Encontre abaixo os nossos contactos ou envie-nos uma mensagem.
					</p>
				</div>
			</section>
