...
export default function TotoDrinkPage() {
	...
	const tabs = [
		{ key: 'sumo_natural', label: t('toto_drink_tab_sumo') },
		{ key: 'detox', label: t('toto_drink_tab_detox') },
	];
		...
		<>
			<section className="page-hero" style={{ backgroundImage: 'url(/img/files/Loja-1920-x-1080.png)' }}>
				<div className="page-hero-content">
					<h1 className="page-hero-title">{t('toto_drink_hero_title')}</h1>
					<p className="page-hero-subtitle">{t('toto_drink_hero_subtitle')}</p>
				</div>
			</section>
				...
				<div className="s-container">
					<div className="brand-showcase" style={{ marginBottom: '60px' }}>
						...
						<div className="brand-showcase-text">
							...
							<h2 className="s-title">{t('toto_drink_hero_title')}</h2>
							<p className="brand-tagline-inline">{t('toto_drink_hero_subtitle')}</p>
							<p>{t('toto_drink_desc_1')}</p>
							<p style={{ marginTop: '16px' }}>{t('toto_drink_desc_2')}</p>
							<Link className="s-btn s-btn-primary" to="/catalog">
								{t('toto_drink_catalog_btn')}
							</Link>
						</div>
					</div>

					<div className="s-header">
						<span className="s-eyebrow">{t('toto_drink_products_eyebrow')}</span>
						<h2 className="s-title">{t('toto_drink_products_title')}</h2>
						<p className="s-sub">{t('toto_drink_products_subtitle')}</p>
					</div>
